...
public class Customer {
    ...
    public Customer(int identifier, String firstName, String lastName, String streetName, String city, String postalCode, String phoneNumber, String emailAddress, LocalDate date) {
        this.identifier = identifier;
        this.firstName = firstName;
        this.lastName = lastName;
        this.streetName = streetName;
