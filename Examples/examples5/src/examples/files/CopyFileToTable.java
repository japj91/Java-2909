...
public class CopyFileToTable extends JFrame {
	...
	private final JComboBox jcboDriver = new JComboBox(new String[] { "com.mysql.jdbc.Driver",
	        "sun.jdbc.odbc.JdbcOdbcDriver", "oracle.jdbc.driver.OracleDriver" });
	@SuppressWarnings({ "rawtypes", "unchecked" })
	private final JComboBox jcboURL = new JComboBox(new String[] { "jdbc:mysql://localhost/test",
	        "jdbc:odbc:exampleMDBDataSource", "jdbc:oracle:thin:@liang.armstrong.edu:1521:ora9i" });
	...
	private final JButton jbtViewFile = new JButton("View File");
	private final JButton jbtCopy = new JButton("Copy");
	...
	private void copyFile() throws Exception {
		...
		Connection conn = DriverManager.getConnection(((String) jcboURL.getSelectedItem()).trim(), jtfUsername
		        .getText().trim(), String.valueOf(jtfPassword.getPassword()).trim());
