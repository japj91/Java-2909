...
public class JOptionPaneDemo {
	public static void main(String args[]) {
		...
		Object annualInterstRateObject = JOptionPane.showInputDialog(null, "Select annual interest rate:", "JOptionPaneDemo",
		...
		Object numberOfYearsObject = JOptionPane.showInputDialog(null, "Select number of years:", "JOptionPaneDemo", JOptionPane.QUESTION_MESSAGE,
				null, yearList, null);
