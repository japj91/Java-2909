...
public class ColorDialog extends JDialog {
	...
	// Create sliders
	private final JSlider jslRed = new JSlider(0, 128);
	private final JSlider jslGreen = new JSlider(0, 128);
	private final JSlider jslBlue = new JSlider(0, 128);

	// Create two buttons
	private final JButton jbtOK = new JButton("OK");
	private final JButton jbtCancel = new JButton("Cancel");

	// Create a panle to display the selected color
	private final JPanel jpSelectedColor = new JPanel();
