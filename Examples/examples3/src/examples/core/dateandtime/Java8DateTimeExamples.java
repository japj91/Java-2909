...
public class Java8DateTimeExamples {
	...
	private static void conversion() {
		...
		System.out.println("conversion: dateTimeFromDateAndTime: " + dateTimeFromDateAndTime);
		LocalDate dateFromDateTime = LocalDateTime.now().toLocalDate();
		System.out.println("conversion: dateFromDateTime: " + dateFromDateTime);
		LocalTime timeFromDateTime = LocalDateTime.now().toLocalTime();
		System.out.println("conversion: timeFromDateTime: " + timeFromDateTime);

		// Instant <-> LocalDateTime
		Instant instant = Instant.now();
		LocalDateTime dateTimeFromInstant = LocalDateTime.ofInstant(instant, ZoneId.of("America/Los_Angeles"));
		System.out.println("conversion: dateTimeFromInstant: " + dateTimeFromInstant);
		Instant instantFromDateTime = LocalDateTime.now().toInstant(ZoneOffset.ofHours(-2));
		System.out.println("conversion: instantFromDateTime: " + instantFromDateTime);

		// convert from/to old date/calendar/timezone classes
		Instant instantFromDate = new Date().toInstant();
		System.out.println("conversion: instantFromDate: " + instantFromDate);
		Instant instantFromCalendar = Calendar.getInstance().toInstant();
		System.out.println("conversion: instantFromCalendar: " + instantFromCalendar);
		ZoneId zoneId = TimeZone.getDefault().toZoneId();
		System.out.println("conversion: zoneId: " + zoneId);
		ZonedDateTime zonedDateTimeFromGregorianCalendar = new GregorianCalendar().toZonedDateTime();
		System.out.println("conversion: zonedDateTimeFromGregorianCalendar: " + zonedDateTimeFromGregorianCalendar);
		Date dateFromInstant = Date.from(Instant.now());
		System.out.println("conversion: dateFromInstant: " + dateFromInstant);
		TimeZone timeZone = TimeZone.getTimeZone(ZoneId.of("America/Los_Angeles"));
		System.out.println("conversion: timeZone: " + timeZone);
		GregorianCalendar gregorianCalendar = GregorianCalendar.from(ZonedDateTime.now());
		System.out.println("conversion: gregorianCalendar: " + gregorianCalendar);
	}
