 ...
 * CustomerReader Date 2017-05-28 Class parses the customer.dat file
 */
	...
	private Customer makeCustomer(String[] customerInfo) throws ApplicationException {
		...
		if (customerInfo.length != 9) {
			throw new ApplicationException(
					String.format("Not enough Arguments %s in the customer class", getString(customerInfo)));
		}
		...
		Customer customer = new Customer(identifier, firstName, lastName, streetName, city, postalCode, phoneNumber,
				emailAddress, date);
