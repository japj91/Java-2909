 ...
 * CustomerReport Date 2017-05-31
 */
	...
	public void printCustomer(LinkedList<Customer> customerLinkedList) {
		...
		for (Customer customer : customerLinkedList) {
			System.out.printf("%-10s %-10s %-18s%-25s %-20s %-13s %-20s%-30s %s\n", customer.getId(),
					customer.getFirstName(), customer.getLastName(), customer.getStreet(), customer.getCity(),
					customer.getPostalCode(), customer.getPhone(), customer.getEmail(), customer.getJoinDate());
		}
		System.out.println(
				"-------------------------------------------------------------------------------------------------------------------------------------------------------------------");
	}
