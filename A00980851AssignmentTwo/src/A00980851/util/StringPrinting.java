 ...
 * StringPrinting Date 2017-05-30 creates a string for the user. Used when
 * errors appear. For example if customer needs 7 args but only has 6 will then
 * show the 6 arguments in the log
 */
